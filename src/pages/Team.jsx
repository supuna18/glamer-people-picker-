...
import { Search, X, Loader2, AlertCircle, User, Check } from 'lucide-react';
...
// --- Mock Data Generator ---
// Note: පසුව අපි මෙය src/data/users.js වෙතින් import කරමු. දැනට මෙතැනම තබා ගනිමු.
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-6">
          <header className="mb-6">
            ...
            <p className="text-slate-400 text-sm mt-1">Search and manage user access for the project.</p>
          </header>
          ...
          <div className="relative z-20">
            <div className={cn(
              ...
              <div className="mr-2 flex items-center gap-2">
                <label className="text-xs text-slate-500 cursor-pointer flex items-center gap-1 hover:text-slate-300">
                  <input 
                    type="checkbox" 
                    checked={forceError} 
        ...
        <div className="md:col-span-1">
          <div className="bg-dark-800 border border-dark-700 rounded-2xl h-full p-6 relative overflow-hidden shadow-lg">
            {activeUser ? (
              <motion.div
                key={activeUser.id}
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className={cn(
                        ...
                        activeUser.status === 'Offline' ? "bg-red-500 shadow-red-500/50" : "bg-green-500 shadow-green-500/50"
                      )}></span>
                      <p className="text-slate-300 text-sm">{activeUser.status || 'Active Now'}</p>
                    </div>
                  </div>
                </div>
              </motion.div>
